      ...
      >
        ...
        <div class="col-12 col-md-8 col-lg-9">
          <div class="titulo-segundo">
            <h2>
              Prueba de conocimientos sobre implementación de comunicaciones
              unificadas y sistemas de seguridad.
            </h2>
          </div>
          <p class="mb-4">
            Validar el conocimiento adquirido sobre implementación de
            comunicaciones unificadas y sistemas de seguridad. Esto se trabaja a
